...
import { Eye, RefreshCw, ChevronRight, Check } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-[#9898A8] leading-relaxed mb-8">
              ...
              natural language. Navigate confidently, anywhere.
            </p>
          ...
          >
            <div className="bg-[#0F0F12] border border-[#1F1F28] rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="mx-4 mb-4 bg-[#141418] border border-[#1F1F28] rounded-xl p-3">
                <p className="text-xs text-[#5A5A6E] mb-1">AI Description</p>
                <p className="text-sm text-[#9898A8] leading-relaxed min-h-[40px]">
                  {displayedText}
                  {isTyping && (
