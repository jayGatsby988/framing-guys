...
import { Eye, EyeOff, Loader2, Mail, Lock, User, Sparkles, ArrowRight, Check } from 'lucide-react'
    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#8B8B9E] mt-1">Start your accessibility journey</p>
        </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#5B5B6E]" />
                <input
                  id="name"
                  type="text"
                  value={name}
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#5B5B6E]" />
                <input
                  id="email"
                  type="email"
                  value={email}
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-[#C4C4D4] mb-1.5">
                Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#5B5B6E]" />
                <input
                  id="password"
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#5B5B6E] hover:text-white transition-colors"
                >
            ...
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="bg-red-500/10 border border-red-500/20 text-red-400 text-sm rounded-lg px-4 py-3"
              >
                {error}
              </motion.div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-medium rounded-xl transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
        ...
        {/* Sign in link */}
        <p className="text-center mt-6 text-[#8B8B9E] text-sm">
